    ...
    public function store(Request $request)
    {
        ...
        $pages = new Page;
          if ($request->feature_image) {
            ...
            $name = uniqid().'-'.str_slug($request->menu_name).'.'.$image->getClientOriginalExtension();
            // $destinationPath = public_path('/storage/pagefeaimage');
            $destinationPath = '/home/xkili9kf6kbi/public_html/anwartechs.com/storage/pagefeaimage';
           ...
           $pages->slug=str_slug($request->page_title);
