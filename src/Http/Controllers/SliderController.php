...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      if ($request->slider_image) {
        ...
        // $destinationPath = '/home/xkili9kf6kbi/public_html/anwartechs.com/storage/slider';
       ...
       //        ->get();
       // $result->save();
       flash('Slider image Created Welcome Aboard!');
