...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit {{$page->page_title}}</h1>
          </div><!-- /.col -->
      <div class="col-sm-6">
    ...
    <form action="{{route('page.update', $page->id)}}" enctype="multipart/form-data" method="post">
      ...
      <div class="form-group"><img src="{{url('/')}}/storage/pagefeaimage/{{ $page['feature_image'] }}" height="100px" />
        <label for="feature_image">Upload Feature Image <small> If need?</small></label>
      ...
      <div class="col-md-4">      
       ...
       <div class="form-group">
         ...
         <select name="parent_id" class="form-control{{ $errors->has('parent_id') ? ' is-invalid' : '' }}" id="parent_id">           
            ...
            <?php $allmenus=App\Menulist::where('menu_level', 1)->get(); ?>
...
var options = {
  ...
  filebrowserImageBrowseUrl: '/anwartechs/public/laravel-filemanager?type=Images',
  filebrowserImageUploadUrl: '/anwartechs/public/laravel-filemanager/upload?type=Images&_token={{csrf_field() }}',
  // filebrowserBrowseUrl: '/anwartechs/public/laravel-filemanager?type=Files',
  // filebrowserUploadUrl: '/anwartechs/public/laravel-filemanager/upload?type=Files&_token={{csrf_field() }}'
};
